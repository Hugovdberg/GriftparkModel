...
# Name and location
modelname = "Griftpark_Random1"
model_workspace = Path(modelname)
model_output_dir = Path("output/random1")
...
kh_field = mf.lpf.hk.array
abs_max = np.abs(np.log10(kh_field)).max()
